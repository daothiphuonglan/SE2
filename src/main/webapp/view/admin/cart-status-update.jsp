                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form action="${statusUpdate}" method="post">
                                            ...
                                            <div class="form-group">
                                                <label class="bmd-label-floating">Discount
                                                    Percentage</label> <input type="text" class="form-control"
                                                                              value="${cart.voucher.discountPercentage}%"
                                                                              disabled>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <div class="col-md-3 dropdown">
                                            <div class="form-group">
                                                ...
                                                <option ${cart.status == "Delivering" ? "selected": ""}>Delivering
                                                </option>
                                                <option ${cart.status == "Delivered" ? "selected": ""}>Delivered
                                                </option>
                                            </select>
                                            </div>
                                        </div>
                                    ...
                                    <button type="submit" class="btn btn-primary pull-right" style="margin-top: 45px">
                                        Save
                                        change
                                    </button>
